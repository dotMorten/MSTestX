...
public class MSTestAdapterSettings
{
    ...
    internal void ValidateSettings(IMessageLogger logger)
    {
        ...
        {
#if !NETFRAMEWORK
            // MSTESTX EDIT: HARDCODE MESSAGE
            logger.SendMessage(TestMessageLevel.Warning, "The runsettings 'AssemblyResolution' entries are only supported in .NET Framework. If your tests are working consider removing this entry otherwise you will need to make sure all dependent assemblies are found in the ouput directory of your test.");
#endif
        }
    }
